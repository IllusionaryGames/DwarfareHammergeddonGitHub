...
public class CreatePlane : ScriptableWizard
{
	...
	void OnWizardCreate()
	{
		...
		//Mesh m = (Mesh)AssetDatabase.LoadAssetAtPath("Assets/DHScript/Editor/" + planeAssetName,typeof(Mesh));
		Mesh m = null;
		if (m == null)
		{
			m = new Mesh();
			...
			AssetDatabase.CreateAsset(m, "Assets/DHScripts/Editor/" + planeAssetName);
